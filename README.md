Here we design and implement a text based information retrieval system. We take a user query and then search a text corpus to find the most relevant file using TF-IDF based searching
